...
class InspeksiDB extends StatefulWidget {
  const InspeksiDB({Key? key}) : super(key: key);

  @override
  _InputDBState createState() => _InputDBState();
}

class _InputDBState extends State<InspeksiDB> {
  // semua data
          ...
          : myData.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) => Card(
                    color: index % 2 == 0 ? const Color.fromARGB(255, 255, 255, 255) : const Color.fromARGB(255, 255, 255, 255),
                    margin: const EdgeInsets.all(15),
                    child: ListTile(
                        title: Text(myData[index]['parameter']),
                        subtitle: Text(myData[index]['hasil']),
